                                                                    ...
                                                                    <div className="space-y-1">
                                                                        <div className="flex items-center gap-2">
                                                                            ...
                                                                            <p className="text-sm font-bold">
                                                                                {format(new Date(iscr.turno.giorno), 'EEE dd/MM', { locale: it })} - {format(new Date(iscr.turno.orarioInizio), 'HH:mm')}
                                                                            </p>
                                                                        </div>
                                                                        {iscr.secondoTurno && (
                                                                            <div className="flex items-center gap-2">
                                                                                ...
                                                                                <p className="text-[11px] text-gray-400 font-bold uppercase italic">
                                                                                    {format(new Date(iscr.secondoTurno.giorno), 'EEE dd/MM', { locale: it })} - {format(new Date(iscr.secondoTurno.orarioInizio), 'HH:mm')}
                                                                                </p>
                                                                            </div>
                                                                        )}
                                                                    </div>
                                                                        ...
                                                                        >
                                                                            {turniTorneo.map(t => (
                                                                                <option key={t.id} value={t.id}>
                                                                                    {format(new Date(t.giorno), 'EEE dd/MM', { locale: it })} {format(new Date(t.orarioInizio), 'HH:mm')}
                                                                                </option>
                                                                            ))}
                                                                        </select>
                                                                    )}
