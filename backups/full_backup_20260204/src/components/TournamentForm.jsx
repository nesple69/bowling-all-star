    ...
    return (
        <form onSubmit={handleSubmit} className="p-8 rounded-3xl neumorphic-out max-w-2xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Tipo Torneo */}
                <div className="space-y-2">
                    <label className="text-sm font-medium ml-4 text-gray-400">Tipo Torneo</label>
                    <div className="relative">
                        <Trophy className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                        <select
                            value={formData.tipo}
                            onChange={(e) => setFormData({ ...formData, tipo: e.target.value })}
                            className="w-full pl-10 pr-4 py-3 rounded-xl neumorphic-in focus:outline-none appearance-none bg-transparent"
                        >
                            <option value="Singolo" className="bg-[#121212]">Singolo</option>
                            <option value="Doppio" className="bg-[#121212]">Doppio</option>
                            <option value="Tris" className="bg-[#121212]">Tris</option>
                            <option value="Squadra" className="bg-[#121212]">Squadra</option>
                        </select>
                    </div>
                </div>
            </div>
